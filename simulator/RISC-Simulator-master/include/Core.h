...
class Core
{
    ...
    private:
		...
		PipelineRegister if_of1;
		PipelineRegister of_ex1;
		PipelineRegister ex_ma1;
		PipelineRegister ma_rw1;
		PipelineRegister if_of2;
		PipelineRegister of_ex2;
		PipelineRegister ex_ma2;
		PipelineRegister ma_rw2;
